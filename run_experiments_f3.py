...
def train_and_search_model(model_class, model_args, DatasetClass,
    ...
    PREPROCESSED_DIR = r"C:\Users\boss9\OneDrive\桌面\專題\機器學習\dataset\feature dim_3\preprocessed"
...
# === model_args 範例 ===
lstm_args = {'input_dim': 3, 'hidden_dim': 64, 'num_layers': 1, 'num_classes': 4}
mlp_args = {'input_dim': 12, 'hidden_dim': 128, 'num_classes': 4}
gru_args = {'input_dim': 3, 'hidden_dim': 64, 'num_layers': 1, 'num_classes': 4}
cnn_args = {'input_dim': 3, 'num_classes': 4}
timesnet_args = {'input_dim': 3, 'hidden_dim': 64, 'num_layers': 2, 'num_classes': 4}
...
if __name__ == "__main__":
    ...
    train_and_search_model(LSTMClassifier, lstm_args,
                           ...
                           batch_sizes, learning_rates, seq_lens,
                           RESULT_DIR=r"C:\Users\boss9\OneDrive\桌面\專題\機器學習\result\feature dim_3\LSTM",
    ...
    train_and_search_model(MLPClassifier, mlp_args,
                           ...
                           batch_sizes, learning_rates, seq_lens,
                           RESULT_DIR=r"C:\Users\boss9\OneDrive\桌面\專題\機器學習\result\feature dim_3\MLP",
                           num_epochs=num_epochs)
    ...
    train_and_search_model(GRUClassifier, gru_args,
                           ...
                           "X_seq{seq_len}_3d.npy", "y_seq{seq_len}_3d.npy",
                           batch_sizes, learning_rates, seq_lens,
                           RESULT_DIR=r"C:\Users\boss9\OneDrive\桌面\專題\機器學習\result\feature dim_3\GRU",
                           num_epochs=num_epochs)
    ...
    train_and_search_model(CNN1DClassifier, cnn_args,
                           ...
                           "X_seq{seq_len}_3d.npy", "y_seq{seq_len}_3d.npy",
                           batch_sizes, learning_rates, seq_lens,
                           RESULT_DIR=r"C:\Users\boss9\OneDrive\桌面\專題\機器學習\result\feature dim_3\CNN",
                           num_epochs=num_epochs)
    ...
    train_and_search_model(TimesNetClassifier, timesnet_args,
                           ...
                           "X_seq{seq_len}_3d.npy", "y_seq{seq_len}_3d.npy",
                           batch_sizes, learning_rates, seq_lens,
                           RESULT_DIR=r"C:\Users\boss9\OneDrive\桌面\專題\機器學習\result\feature dim_3\TimesNet",
                           num_epochs=num_epochs)